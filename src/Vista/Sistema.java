...
public final class Sistema extends javax.swing.JFrame {
    ...
    CategoriasDao CrDao = new CategoriasDao();
    Productos pro = new Productos();
    ProductosDao proDao = new ProductosDao();
    Venta v = new Venta();
    VentaDao Vdao = new VentaDao();
    Detalle Dv = new Detalle();
    NameFarmacia name = new NameFarmacia();
    ...
    public void ListarCategorias() {
        List<Categorias> ListarCr = CrDao.ListarCategorias();
        modelo = (DefaultTableModel) TableProveedor.getModel();
        Object[] ob = new Object[4];
        for (int i = 0; i < ListarCr.size(); i++) {
            ob[0] = ListarCr.get(i).getId();
            ob[1] = ListarCr.get(i).getNombre();
            ob[2] = ListarCr.get(i).getDescripcion();
            modelo.addRow(ob);
        }
    ...
    public void ListarProductos() {
        ...
        for (int i = 0; i < ListarPro.size(); i++) {
            ...
            ob[3] = ListarPro.get(i).getNombreCategorias();
    ...
    public void ListarNameFarmacia() {
        name = proDao.BuscarDatos();
        txtIdConfig.setText("" + name.getId());
        txtRucConfig.setText("" + name.getSuc());
        txtNombreConfig.setText("" + name.getNombre());
        txtTelefonoConfig.setText("" + name.getTelefono());
        txtDireccionConfig.setText("" + name.getDireccion());
        txtMensaje.setText("" + name.getMensaje());
    }
    ...
    public void ListarVentas() {
        ...
        for (int i = 0; i < ListarVenta.size(); i++) {
            ...
            ob[2] = ListarVenta.get(i).getUsuario();
    ...
    private void initComponents() {
        ...
        btnNuevaVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/boton.png"))); // NOI18N
        btnNuevaVenta.setText("Nueva Venta");
        btnNuevaVenta.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnNuevaVenta.setFocusable(false);
        btnNuevaVenta.setMaximumSize(new java.awt.Dimension(103, 35));
        btnNuevaVenta.setMinimumSize(new java.awt.Dimension(103, 35));
        ...
        btnClientes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/agregar.png"))); // NOI18N
        btnClientes.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnClientes.setFocusable(false);
        btnClientes.setLabel("Agregar Cliente");
        ...
        btnProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/categorias.png"))); // NOI18N
        btnProveedor.setActionCommand("Categorias");
        btnProveedor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnProveedor.setFocusable(false);
        btnProveedor.setLabel("Categorias");
        ...
        btnProductos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/medicina.png"))); // NOI18N
        ...
        btnUsuarios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/doctor.png"))); // NOI18N
        ...
        getContentPane().add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 60, -1, -1));

        LabelVendedor.setFont(new java.awt.Font("Yu Gothic UI Light", 3, 36)); // NOI18N
        LabelVendedor.setText("Administrador");
        getContentPane().add(LabelVendedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 60, 620, 50));

        help.setEditable(false);
        help.setBackground(new java.awt.Color(93, 173, 226));
        help.setColumns(20);
        help.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        help.setRows(5);
        getContentPane().add(help, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 10, 390, 130));

        jLabel2.setBackground(new java.awt.Color(93, 173, 226));
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Head.png"))); // NOI18N
        ...
        jLabel6.setText("Borrar de Lista");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 120, -1, -1));
        ...
        TableVenta.setBackground(new java.awt.Color(93, 173, 226));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 843, 191));
        ...
        jPanel2.add(btnEliminarventa, new org.netbeans.lib.awtextra.AbsoluteConstraints(713, 110, 50, 40));
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 360, -1, -1));
        ...
        btnGenerarVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/moneda.png"))); // NOI18N
        ...
        jPanel2.add(btnGenerarVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 370, 50, 60));
        ...
        jPanel2.add(btnGraficar, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 40, 80, 60));
        ...
        jLabel20.setText("Cobrar");
        jPanel2.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 390, 60, 20));

        jLabel42.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel42.setText("Graficar");
        ...
        TableCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "APELLIDO", "NOMBRE", "TELEFONO", "DIRECCION"
            }
        ) {
        ...
        jPanel9.add(txtIdCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 30, -1));

        btnGuardarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/guarda.png"))); // NOI18N
        ...
        jPanel9.add(btnGuardarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 260, 90, 35));
        ...
        jPanel9.add(btnEditarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 100, 40));
        ...
        jPanel9.add(btnEliminarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 320, -1, 40));

        btnNuevoCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/agregarusuario.png"))); // NOI18N
        ...
        jPanel9.add(btnNuevoCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 320, -1, 40));
        ...
        jPanel4.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(323, 57, 520, 370));
        ...
        jPanel10.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, -1, -1));

        txtNombreproveedor.setBackground(new java.awt.Color(204, 204, 204));
        txtNombreproveedor.setBorder(null);
        txtNombreproveedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNombrecategoriasActionPerformed(evt);
            }
        });
        jPanel10.add(txtNombreproveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 138, 30));
        ...
        btnguardarProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/guarda.png"))); // NOI18N
        ...
        jPanel10.add(btnguardarProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, 90, 35));
        ...
        jPanel10.add(btnEditarProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 70, 35));

        btnNuevoProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/categorias.png"))); // NOI18N
        ...
        jPanel10.add(btnNuevoProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, 90, 35));
        ...
        jPanel10.add(btnEliminarProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 320, 90, 35));
        ...
        jPanel10.add(txtIdProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 24, -1));
        ...
        jPanel10.add(jPanel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, 138, 2));
        ...
        jLabel33.setText("Nueva Categoria");
        ...
        jPanel10.add(jPanel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 290, 50));

        jPanel4.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 290, 380));
        ...
        jPanel11.setMinimumSize(new java.awt.Dimension(265, 365));
        ...
        btnGuardarpro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/guarda.png"))); // NOI18N
        ...
        jPanel11.add(btnGuardarpro, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, -1, 35));
        ...
        jPanel11.add(btnEditarpro, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 320, -1, 35));
        ...
        jPanel11.add(btnEliminarPro, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 370, -1, 35));

        btnNuevoPro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/medicina.png"))); // NOI18N
        ...
        jPanel11.add(btnNuevoPro, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, -1, 35));
        ...
        jPanel5.add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 250, 420));
        ...
        jPanel8.add(btnActualizarConfig, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 270, 180, 70));
        ...
        jPanel7.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 420, 350));

        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/empresa.jpg"))); // NOI18N
        jPanel7.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 30, 410, 410));
        ...
        jPanel13.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, -1, -1));
        ...
        jPanel13.add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 226, 30));
        ...
        jPanel13.add(btnIniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, 226, 34));
        ...
        jPanel13.add(jPanel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 230, 2));
        ...
        jPanel13.add(jPanel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 226, 2));
        ...
        jPanel13.add(btnIniciar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, 226, 34));
        ...
        jPanel12.add(txtIdUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 430, 20, -1));
        txtIdUsuario.getAccessibleContext().setAccessibleParent(jPanel13);

        jTabbedPane1.addTab("7", jPanel12);

        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 95, 870, 490));
    ...
    private void btnActualizarConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarConfigActionPerformed
        ...
        if (!"".equals(txtRucConfig.getText()) || !"".equals(txtNombreConfig.getText()) || !"".equals(txtTelefonoConfig.getText()) || !"".equals(txtDireccionConfig.getText())) {
            name.setSuc(txtRucConfig.getText());
            name.setNombre(txtNombreConfig.getText());
            name.setTelefono(txtTelefonoConfig.getText());
            name.setDireccion(txtDireccionConfig.getText());
            name.setMensaje(txtMensaje.getText());
            name.setId(Integer.parseInt(txtIdConfig.getText()));
            proDao.ModificarDatos(name);
    ...
    private void btnPdfVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPdfVentasActionPerformed
        ...
        if (txtIdVenta.getText().equals("")) {
            ...
            Vdao.pdfV(v.getId(), v.getCliente(), v.getTotal(), v.getUsuario());
        }
    ...
    private void TableProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableProductoMouseClicked
        ...
        cbxProveedorPro.setSelectedItem( new Combo(pro.getCategorias(), pro.getNombreCategorias()));
    ...
    private void btnEditarProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarProveedorActionPerformed
        ...
        if ("".equals(txtIdProveedor.getText())) {
            ...
            if (!"".equals(txtNombreproveedor.getText()) || !"".equals(txtTelefonoProveedor.getText())) {
                cr.setNombre(txtNombreproveedor.getText());
                cr.setDescripcion(txtTelefonoProveedor.getText());
                CrDao.ModificarCategorias(cr);
    ...
    private void btnUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuariosActionPerformed
        ...
        help.setText(
                "Esta seccion nos sirve para dar de alta un nuevo usuario,\n"
                + "ya sea Administrador o PERSONAL\n"
                + "como administrador tienes todos las funciones activas.\n\n"
                + "Como personal estas limitado de funciones\n"
                + "Solo puedes registrar clientes,realizar ventas\n"
                + "NO PUEDES MANIPULAR datos sensibles($)");
    ...
    private void btnConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfigActionPerformed
        ...
        help.setVisible(true);
        help.setText(
                "Esta seccion nos sirve para recoger datos del local,\n"
                + "para que los cambios resulten efectivos\n"
                + "sigue los pasos:\n\n"
                + "-Llena los campos con los datos que se te piden\n"
                + "-Al llenar todos los campos presiona boton ACTUALIZAR\n"
                + "-Si te equivocaste, repite el primer paso");
    ...
    private void btnVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVentasActionPerformed
        ...
        ListarVentas();
         ...
         help.setVisible(true);
        help.setText(
                "Al presionar el boton del icono PDF, este mostrara\n"
                + "el tikcet que nosotros solicitemos en ese momento\n"
                + "para ello has esto:\n\n"
                + "Presionar sobre cualquier venta dentro de la lista\n"
                + "Presionar el icono de PDF para mostrar el ticket\n"
                + "Nos mostrara el ticket solicitado");
    ...
    private void btnProductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductosActionPerformed
        ...
        LimpiarProductos();
         ...
         help.setVisible(true);
        help.setText(
                "Para poder registrar un producto,es necesario ingresar\n"
                + "todos los datos que pide el formulario,ya que no\n"
                + "podras seguir con el proceso \n\n"
                + "Presionar el boton guardar para registrar producto\n"
                + "Presionar el producto registrado si deseas editar\n"
                + "Presionar sobre el boton eliminar si deseas eliminar");
    ...
    private void btnProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProveedorActionPerformed
        ...
        help.setVisible(true);
        help.setText(
                "Para poder registrar una categoria,es necesario ingresar\n"
                + "todos los datos que pide el formulario,ya que no\n"
                + "podras seguir con el proceso \n\n"
                + "Presionar el boton guardar para regsitrar categoria\n"
                + "Presionar la categoria registrada si deseas editar\n"
                + "Presionar sobre el boton eliminar si deseas eliminar");
    ...
    private void btnClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClientesActionPerformed
        ...
        help.setVisible(true);
        help.setText(
                "Para poder registrar un cliente,es necesario ingresar\n"
                + "todos los datos que pide el formulario,ya que no\n"
                + "podras seguir con el proceso \n\n"
                + "Presionar el boton guardar para registrar cliente\n"
                + "Presionar el cliente registrado si deseas editar\n"
                + "Presionar sobre el boton eliminar si deseas eliminar");
    ...
    private void btnNuevaVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevaVentaActionPerformed
       ...
       help.setVisible(true);
        help.setText(
                "Para poder realizar una compra,es necesario ingresar\n"
                + "el codigo del producto,con el que se regsitro,\n"
                + "despues dar enter \n\n"
                + "Elegir el numero de productos\n"
                + "Agregar un cliente y por ultimo\n"
                + "Presionar el boton de cobrar");
    ...
    private void txtNombrecategoriasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNombrecategoriasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNombrecategoriasActionPerformed
    ...
    private void llenarCategorias() {
        List<Categorias> lista = CrDao.ListarCategorias();
